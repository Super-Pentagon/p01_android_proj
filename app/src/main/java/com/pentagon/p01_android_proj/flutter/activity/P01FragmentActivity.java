package com.pentagon.p01_android_proj.flutter.activity;
...
public class P01FragmentActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p01_fragment);
